...
func RegisterDefaultPlugins(registry pluginregistry.Registry) {
	...
	pluginregistry.Register(nodeutilization.MyLowNodeUtilizationPluginName, nodeutilization.NewMyLowNodeUtilization, &nodeutilization.MyLowNodeUtilization{}, &nodeutilization.LowNodeUtilizationArgs{}, nodeutilization.ValidateLowNodeUtilizationArgs, nodeutilization.SetDefaults_LowNodeUtilizationArgs, registry)
}
